...
for epochs in [100, 200, 300, 400]:
    ...
    experiment.set_name("cyclic_tent_linear_{}".format(epochs))
    learning_rate = 0.001
    n_resets = 4
    ...
    scheduler = TentCyclicLearningRate(PolynomialDecay(max_epochs=int(epochs/2), init_alpha=learning_rate, power=1),
                                       reset_epoch=epochs)
