...
for epochs in [100, 200, 300, 400]:
    ...
    experiment.set_name("cyclic_0.33order_{}".format(epochs))
    learning_rate = 0.001
    n_resets = 4
    ...
    scheduler = CyclicLearningRate(PolynomialDecay(max_epochs=epochs, init_alpha=learning_rate, power=0.33),
                                   reset_epoch=epochs)
    train_cifar10(batch_size=64, learning_rate=learning_rate, epochs=epochs*n_resets, experiment=experiment, model=model,
